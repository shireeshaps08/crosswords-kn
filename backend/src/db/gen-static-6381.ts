...
const clues = {
  across: [
    ...
    { number:14, clue:'ಅದೇ ತಾನೇ ಕಡೆದ ಹೊಸಬೆಣ್ಣೆ',                  answer:'ನವನೀತ',     direction:'across', row:8, col:0, length:4 },
    { number:15, clue:'ವರ ಪಡೆದಿರುವ ಬೇಡ',                          answer:'ವಾಲ್ಮೀಕಿ',  direction:'across', row:8, col:5, length:4 },
  ],
  down: [
