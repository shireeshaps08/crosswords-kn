// Puzzle 6381 - Kannada Crossword (PV Padabandha)
// Unicode Kannada clues and answers
...
const puzzle6381 = {
  ...
  down_clues: [
    ...
    { number: 6,  clue: 'ವರನಲ್ಲಿ ಪ್ರತಿನಿಧಿ ಕಾಣಿಸಿದನೇ?',               answer: 'ವಕ್ತಾರ',    length: 3 },
    ...
    { number: 9,  clue: 'ರಾಯರಿಂದ ಬಂದಿರುವ ನಿರೂಪ',                     answer: 'ರಾಯಸ',       length: 3 },
    { number: 10, clue: 'ಮನೆಯನ್ನು ಹೀಗೂ ಹೇಳುತ್ತಾರೆ',                  answer: 'ವಾಸಸ್ಥಾನ',  length: 4 },
